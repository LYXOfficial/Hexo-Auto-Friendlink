...
def changependinglink(er:EditRequest,response:Response):
    if "<script" in er.name.lower() or "javascript:" in er.name.lower()\
        or "<script" in er.avatar.lower() or "javascript:" in er.avatar.lower()\
        or "<script" in er.link.lower() or "javascript:" in er.link.lower()\
        or "<script" in er.descr.lower() or "javascript:" in er.descr.lower()\
        or "<script" in er.color.lower() or "javascript:" in er.color.lower():
            response.status_code=406
            return {"message":"XSS attack?"}
